		...
		<div class="body row">
			...
			<div class="column2">
				...
				<table>
					...
					<c:forEach items="${realTaxes}" var="n">
					    	<tr>
                        	    <td>${n.formattedTaxRate}</td>
                        	    <td>${n.formattedSalarySingleSalary}</td>
                        	    <td>${n.formattedMarriedFilingJointSalary}</td>
                        	    <td>${n.formattedHeadOfHouseholdSalary}</td>
                        	</tr>
					</c:forEach>
					</tbody>
				</table>
				...
				<p>
					...
					<ul>
                        <c:forEach items="${taxesCalc}" var="n">
                                <li>
